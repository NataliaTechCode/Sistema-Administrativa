                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <div class="header">
                                        <h2><strong>Añadir</strong> nuevo departamento</h2>
                            ...
                            <div class="col-12">
                                ...
                                <form name="formulario" id="formulario" method="POST">
                                    <div class="form-group form-float">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nombre Departamento" name="nombre" id="nombre">
                                    </div>                                    
                                </form>
...
<script type="text/javascript" src="script/departamento.js"></script>   
