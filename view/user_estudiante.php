                                ...
                                <form name="formulario" id="formulario" method="POST">
                                    ...
                                    <div class="body">
                                        <div class="row clearfix">
                                            <div class="col-sm-6">
                                                <select class="form-control show-tick" name="tipoestudiante" id="tipoestudiante" data-live-search="true" required>
                                                </select>
                                            </div>
                                            <div class="col-sm-6">
                                                <select class="form-control show-tick" name="carrera" id="carrera" data-live-search="true" required>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
